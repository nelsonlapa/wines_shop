<footer class="wine-footer text-stone-300 mt-20">
    <div class="container mx-auto px-6 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
                <h2 class="text-xl font-bold text-white mb-4"><span class="brand-script text-amber-200">Aroma</span><span class="text-stone-100"> Nobre</span></h2>
            ...
            <div>
                ...
                <p class="text-sm text-stone-400 mt-2">hello@aromanobre.pt</p>
        ...
        <div class="border-t border-stone-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
            <p class="text-sm text-stone-500">© {{ date('Y') }} Aroma Nobre. Beba com moderação.</p>
